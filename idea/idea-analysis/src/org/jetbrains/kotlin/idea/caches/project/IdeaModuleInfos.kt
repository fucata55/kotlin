...
data class ModuleProductionSourceInfo internal constructor(
    ...
    override val name = module.getStableName() ?: Name.special("<production sources for module ${module.name}>")
...
data class ModuleTestSourceInfo internal constructor(override val module: Module) :
    ...
    override val name = module.getStableName() ?: Name.special("<test sources for module ${module.name}>")
